...
void Renderer::nanogui_init(GLFWwindow* window)
{
	...
	gui_1->addVariable("Rotate X1", m_bone_animation->rotation_degree_vector[1][0]);
	gui_1->addVariable("Rotate Y1", m_bone_animation->rotation_degree_vector[1][1]);
	gui_1->addVariable("Rotate Z1", m_bone_animation->rotation_degree_vector[1][2]);
	gui_1->addVariable("Rotate X2", m_bone_animation->rotation_degree_vector[2][0]);
	gui_1->addVariable("Rotate Y2", m_bone_animation->rotation_degree_vector[2][1]);
	gui_1->addVariable("Rotate Z2", m_bone_animation->rotation_degree_vector[2][2]);
	gui_1->addVariable("Rotate X3", m_bone_animation->rotation_degree_vector[3][0]);
	gui_1->addVariable("Rotate Y3", m_bone_animation->rotation_degree_vector[3][1]);
	gui_1->addVariable("Rotate Z3", m_bone_animation->rotation_degree_vector[3][2]);
...
void Renderer::draw_bones(Shader& shader, Bone_Animation* m_bone_animation)
{
	...
	//draw yellow bone
	glm::mat4 yellow_bone_obj_mat = m_bone_animation->yellow_bone_matrix();
	...
	//Draw purple bone
	glm::mat4 purple_bone_obj_mat = m_bone_animation->purple_bone_matrix();

	glUniformMatrix4fv(glGetUniformLocation(shader.program, "model"), 1, GL_FALSE, glm::value_ptr(purple_bone_obj_mat));
	bone_obj->obj_color = m_bone_animation->colors[2];
	draw_object(shader, *bone_obj);

	//Draw blue bone
	glm::mat4 blue_bone_obj_mat = m_bone_animation->blue_bone_matrix();

	glUniformMatrix4fv(glGetUniformLocation(shader.program, "model"), 1, GL_FALSE, glm::value_ptr(blue_bone_obj_mat));
